...
pic = slide.shapes.add_picture("../construction/plots/" + "bespoke_plot_heatmap_all_clusters.png", left = Inches(0.35), top = Inches(2.85), height = Inches(4.5))
add_text(0.15, 2.75, 14, 'D')
pic = slide.shapes.add_picture("../construction/plots/" + "bespoke_plot_heatmap_legend_alt.png", left = Inches(0.5), top = Inches(7.5), height = Inches(0.75))
...
# new slide
slide = add_slide(prs, blank_slide_layout, "Figure 3. Contextualizing the CARTEx signature")
...
pic = slide.shapes.add_picture("../construction/plots/" + "barplot_significant_pathways.png", top = Inches(8.5), left = Inches(0), height = Inches(1.8))
...
# new slide
slide = add_slide(prs, blank_slide_layout, "Figure 4. Analysis of 39,937 CD8+ T cells from healthy donors across 9 decades of life")
...
pic = slide.shapes.add_picture("../experiments/" + experiment + "/plots/" + experiment + "_aggplot_CARTEx_200_group_monaco_split_countsized.png", top = Inches(6), left = Inches(6.5), height = Inches(2))
add_text(6.35, 6, 14, 'I')

pic = slide.shapes.add_picture("../experiments/" + experiment + "/plots/" + experiment + "_cs_extract_umap_highlight_combined.png", top = Inches(8.25), left = Inches(0.25), height = Inches(1.6))
...
pic = slide.shapes.add_picture("../experiments/" + experiment + "/plots/" + experiment + "_aggplot_CARTEx_200_TissueType_monaco_split_countsized.png", top = Inches(6), left = Inches(7.5), height = Inches(2))
add_text(7.4, 6, 14, 'J')
...
# new slide
slide = add_slide(prs, blank_slide_layout, "Figure 5. Analysis of 14,436 functional and exhaustion-prone CD8+ CAR T cells")
...
pic = slide.shapes.add_picture("../experiments/" + experiment + "/plots/" + experiment + "_featplot_CARTEx_200_CAR.png", left = Inches(0.25), top = Inches(2.5), height = Inches(1.5))
...
pic = slide.shapes.add_picture("../experiments/" + experiment + "/plots/" + experiment + "_transition_volcano_GD2vCD19_200.png", left = Inches(3.75), top = Inches(2.5), height = Inches(2))
add_text(3.6, 2.5, 14, 'E')

pic = slide.shapes.add_picture("../experiments/" + experiment + "/plots/" + experiment + "_query_agg_aggplot_CARTEx_200.png", left = Inches(6.4), top = Inches(2.5), height = Inches(2))
add_text(6.25, 2.5, 14, 'F')

pic = slide.shapes.add_picture("../experiments/" + experiment + "/plots/" + experiment + "_aggplot_CARTEx_200_CAR_monaco_split_countsized.png", left = Inches(8.5), top = Inches(2.5), height = Inches(2))
add_text(8.35, 2.5, 14, 'G')

experiment = "GSE160160" # Continuous antigen exposure experiment

pic = slide.shapes.add_picture("../experiments/" + experiment + "/plots/" + experiment + "_prepare_umap_exposure.png", left = Inches(0.25), top = Inches(5), height = Inches(1.5))
add_text(0.15, 5, 14, 'H')

pic = slide.shapes.add_picture("../experiments/" + experiment + "/plots/" + experiment + "_prepare_umap_phase.png", left = Inches(2.5), top = Inches(5), height = Inches(1.5))
add_text(2.4, 5, 14, 'I')

pic = slide.shapes.add_picture("../experiments/" + experiment + "/plots/" + experiment + "_prepare_barplot_phase_exposure_slim.png", left = Inches(5), top = Inches(5), height = Inches(1.25))

pic = slide.shapes.add_picture("../experiments/" + experiment + "/plots/" + experiment + "_prepare_umap_predicted_monaco.png", left = Inches(6.5), top = Inches(5), height = Inches(1.5))
add_text(6.4, 5, 14, 'J')

pic = slide.shapes.add_picture("../experiments/" + experiment + "/plots/" + experiment + "_prepare_barplot_monaco_exposure_slim.png", left = Inches(9), top = Inches(5), height = Inches(1.25))
...
pic = slide.shapes.add_picture("../experiments/" + experiment + "/plots/" + experiment + "_featplot_CARTEx_200_exposure.png", left = Inches(0.25), top = Inches(6.75), height = Inches(1.5))
add_text(0.15, 6.75, 14, 'K')

pic = slide.shapes.add_picture("../experiments/" + experiment + "/plots/" + experiment + "_prepare_umap_CARTEx_200.png", left = Inches(1.5), top = Inches(6.75), height = Inches(1.5))

pic = slide.shapes.add_picture("../experiments/" + experiment + "/plots/" + experiment + "_explore_volcano_CAEvday0_200.png", left = Inches(3.75), top = Inches(6.75), height = Inches(2))
add_text(3.6, 6.75, 14, 'L')

pic = slide.shapes.add_picture("../experiments/" + experiment + "/plots/" + experiment + "_query_agg_aggplot_CARTEx_200.png", left = Inches(6.4), top = Inches(6.75), height = Inches(2))
add_text(6.25, 6.75, 14, 'M')

pic = slide.shapes.add_picture("../experiments/" + experiment + "/plots/" + experiment + "_aggplot_CARTEx_200_exposure_monaco_split_countsized.png", left = Inches(8.5), top = Inches(6.75), height = Inches(2))
add_text(8.4, 6.75, 14, 'N')
...
# new slide
slide = add_slide(prs, blank_slide_layout, "Figure 6. Analysis of 101,626 CD8+ endogenous and CAR T cells in clinical oncology")
...
# new slide
slide = add_slide(prs, blank_slide_layout, "Supplementary Figure 4. Analysis of 61,583 CD8+ virus-reactive T cells including those with memory response to SARS-CoV-2")
...
# new slide
slide = add_slide(prs, blank_slide_layout, "Figure 7. Analysis of 25,191 CD8+ T cells from patients with STAT3 GOF syndrome")
...
# new slide
slide = add_slide(prs, blank_slide_layout, "Supplementary Figure 5. Additional analysis of STAT3 GOF CD8+ T cells")
...
# new slide
slide = add_slide(prs, blank_slide_layout, "Supplementary Figure 6. Analysis of 3,342 CD8+ T cells from patients with severe psoriasis")
...
# new slide
slide = add_slide(prs, blank_slide_layout, "Supplementary Figure 7. Analysis of 8,118 CD8+ T cells from patients with BEACH domain deficiencies")
...
# new slide
slide = add_slide(prs, blank_slide_layout, "Supplementary Figure 8. Analysis of 28,105 CD8+ T cells from patients with Parkinson's disease")
