...
### Script name: mdandersonTCM-3-integrate.R
### Description: integrate seurat object for mdandersonTCM
### Author: Vandon Duong
...
expt.obj@meta.data[['identifier2']] <- expt.obj@meta.data$TissueType
