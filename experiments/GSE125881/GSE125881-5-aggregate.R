...
aggplot_CARTEx_200 <- md %>% ggplot(aes(identifier4, CARTEx_200)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('Early','OldTerminal')), label = "p.signif", label.y = 2) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('IP','YoungNaive')), label = "p.signif", label.y = 2.5) +
  ylab("CARTEx 200") + xlab(NULL) + geom_point() + ylim(-3, 3)+ theme_classic() + theme(legend.position="none", text=element_text(size=16)) 
...
aggplot_CARTEx_630 <- md %>% ggplot(aes(identifier4, CARTEx_630)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('Early','OldTerminal')), label = "p.signif", label.y = 2) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('IP','YoungNaive')), label = "p.signif", label.y = 2.5) +
  ylab("CARTEx 630") + xlab(NULL) + geom_point() + ylim(-3, 3) + theme_classic() + theme(legend.position="none", text=element_text(size=16)) 
...
aggplot_NKlike_Tex <- md %>% ggplot(aes(identifier4, NKlike_Tex)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('Early','OldTerminal')), label = "p.signif", label.y = 2) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('IP','YoungNaive')), label = "p.signif", label.y = 2.5) +
  ylab("NK-like") + xlab(NULL) + geom_point() + ylim(-3, 3) + theme_classic() + theme(legend.position="none", text=element_text(size=16)) 
...
aggplot_LCMV_Tex <- md %>% ggplot(aes(identifier4, LCMV_Tex)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('Early','OldTerminal')), label = "p.signif", label.y = 2) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('IP','YoungNaive')), label = "p.signif", label.y = 2.5) +
  ylab("LCMV") + xlab(NULL)  + geom_point() + ylim(-3, 3) + theme_classic() + theme(legend.position="none", text=element_text(size=16)) 
...
aggplot_BBD_Tex <- md %>% ggplot(aes(identifier4, BBD_Tex)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('Early','OldTerminal')), label = "p.signif", label.y = 2) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('IP','YoungNaive')), label = "p.signif", label.y = 2.5) +
  ylab("BBD") + xlab(NULL) + geom_point() + ylim(-3, 3) + theme_classic() + theme(legend.position="none", text=element_text(size=16)) 
...
aggplot_PD1_Tex <- md %>% ggplot(aes(identifier4, PD1_Tex)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('Early','OldTerminal')), label = "p.signif", label.y = 2) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('IP','YoungNaive')), label = "p.signif", label.y = 2.5) +
  ylab("PD1") + xlab(NULL) + geom_point() + ylim(-3, 3) + theme_classic() + theme(legend.position="none", text=element_text(size=16)) 
