...
generate_figs(featplot_CARTEx_combined_group, paste('./plots/', experiment, '_featplot_CARTEx_combined_group', sep = ''), c(10,5))
...
generate_figs(plot_volcano_ExpansionPeak_Late, paste('./plots/', experiment, '_plot_volcano_ExpansionPeak_Late', sep = ''), c(10, 8))
...
generate_figs(plot_volcano_ExpansionPeak_IP, paste('./plots/', experiment, '_plot_volcano_ExpansionPeak_IP', sep = ''), c(10, 8))
