...
### Script name: GSE125881-2-annotate.R
...
barplot_monaco_group2_slim <- barplot_monaco_group2 + theme(legend.position = "none")
generate_figs(barplot_monaco_group2_slim, paste('./plots/', experiment, '_prepare_barplot_monaco_group2_slim', sep = ''), c(2,4))

barplot_phase_group2_slim <- barplot_phase_group2 + theme(legend.position = "none")
generate_figs(barplot_phase_group2_slim, paste('./plots/', experiment, '_prepare_barplot_phase_group2_slim', sep = ''), c(2,4))
