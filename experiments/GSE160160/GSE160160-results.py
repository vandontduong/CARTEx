...
description = "continous antigen exposure in CAR T cells"
...
pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_umap_exposure.png", left = Inches(0.5), top = Inches(1), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_umap_donor.png", left = Inches(0.5), top = Inches(4.5), height = Inches(3))
...
pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_barplot_phase_exposure.png", left = Inches(5.5), top = Inches(4.5), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_barplot_monaco_exposure.png", left = Inches(10.5), top = Inches(4.5), height = Inches(3))
...
pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_umap_CARTEx_200.png", left = Inches(5.5), top = Inches(1), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_umap_CARTEx_84.png", left = Inches(10.5), top = Inches(1), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_umap_LCMV_Tex.png", left = Inches(0.5), top = Inches(4.5), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_umap_NKlike_Tex.png", left = Inches(5.5), top = Inches(4.5), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_umap_BBD_Tex.png", left = Inches(10.5), top = Inches(4.5), height = Inches(3))

# new slide
slide = add_slide(prs, blank_slide_layout, "Percentage of CARTEx detected")

pic = slide.shapes.add_picture("./plots/" + experiment + "_featplot_CARTEx_combined_exposure.png", left = Inches(0.25), top = Inches(1), height = Inches(4))

# new slide
slide = add_slide(prs, blank_slide_layout, "Cell type differentiation")

pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_vlnplot_CARTEx_exposure_monaco.png", left = Inches(0.25), top = Inches(1), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_swarmplot_CARTEx_exposure_monaco.png", left = Inches(0.25), top = Inches(4.5), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_aggplot_CARTEx_200_exposure_monaco_split_countsized.png", left = Inches(8.25), top = Inches(1), height = Inches(5))
...
pic = slide.shapes.add_picture("./plots/" + experiment + "_query_agg_aggplot_CARTEx_200.png", left = Inches(5.5), top = Inches(1), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_query_agg_aggplot_CARTEx_84.png", left = Inches(10.5), top = Inches(1), height = Inches(3))
...
pic = slide.shapes.add_picture("./plots/" + experiment + "_query_agg_aggplot_NKlike_Tex.png", left = Inches(5.5), top = Inches(4.5), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_query_agg_aggplot_BBD_Tex.png", left = Inches(10.5), top = Inches(4.5), height = Inches(3))
...
pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_vlnplot_exposure_exhaustion_markers.png", left = Inches(0.5), top = Inches(1), height = Inches(8))
...
pic = slide.shapes.add_picture("./plots/" + experiment + "_explore_volcano_CAEvday0.png", left = Inches(0.5), top = Inches(1), height = Inches(5))
