...
pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_umap_exposure.jpeg", left = Inches(0.5), top = Inches(1), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_umap_donor.jpeg", left = Inches(0.5), top = Inches(4.5), height = Inches(3))
...
pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_barplot_phase_exposure.jpeg", left = Inches(5.5), top = Inches(4.5), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_barplot_monaco_exposure.jpeg", left = Inches(10.5), top = Inches(4.5), height = Inches(3))
...
pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_vlnplot_exposure_exhaustion_markers.jpeg", left = Inches(0.5), top = Inches(1), height = Inches(8))
