...
### Script name: GSE160160-2-annotate.R
### Description: annotate seurat object for GSE160160
### Author: Vandon Duong
...
barplot_monaco_exposure <- BarPlotStackSplit(expt.obj, 'monaco', 'exposure', color_set = c('deepskyblue', 'seagreen', 'darkgoldenrod', 'plum3')) + scale_x_discrete(labels = c('D0', 'D20'))
...
barplot_phase_exposure <- BarPlotStackSplit(expt.obj, 'Phase', 'exposure', color_set = hcl.colors(3, palette = "Temps")) + scale_x_discrete(labels = c('D0', 'D20'))
...
generate_figs(barplot_monaco_exposure_slim, paste('./plots/', experiment, '_prepare_barplot_monaco_exposure_slim', sep = ''), c(1.25,1.75))

barplot_phase_exposure_slim <- barplot_phase_exposure + theme(legend.position = "none")
generate_figs(barplot_phase_exposure_slim, paste('./plots/', experiment, '_prepare_barplot_phase_exposure_slim', sep = ''), c(1.25,1.75))
...
barplot_tex_linear_diff_exposure <- BarPlotStackSplit(expt.obj, 'Tex_linear_diff', 'exposure', color_set =  c('royalblue', 'maroon', 'lightgrey')) + scale_x_discrete(labels = c('D0', 'D20'))
barplot_tex_linear_diff_exposure_slim <- barplot_tex_linear_diff_exposure + theme(legend.position = "none")
generate_figs(barplot_tex_linear_diff_exposure_slim, paste('./plots/', experiment, '_prepare_barplot_tex_linear_diff_exposure_slim', sep = ''), c(1.25,1.75))
...
rogue.res <- EntropyScore(expt.obj, 'seurat_clusters', 'exposure')
rogue.res <- rogue.res[ , SortNumStrList(colnames(rogue.res), shift = FALSE)]
rogue_boxplot_seurat_clusters_exposure <- rogue.boxplot(rogue.res)
generate_figs(rogue_boxplot_seurat_clusters_exposure, paste('./plots/', experiment, '_prepare_rogue_boxplot_seurat_clusters_exposure', sep = ''), c(8,4))

rogue.res <- EntropyScore(expt.obj, 'monaco', 'exposure')
rogue_boxplot_monaco_exposure <- rogue.boxplot(rogue.res)
generate_figs(rogue_boxplot_monaco_exposure, paste('./plots/', experiment, '_prepare_rogue_boxplot_monaco_exposure', sep = ''), c(8,4))
...
generate_figs(umap_CARTEx_630, paste('./plots/', experiment, '_prepare_umap_CARTEx_630', sep = ''), c(2.8, 2))
generate_figs(umap_sig_activation, paste('./plots/', experiment, '_prepare_umap_sig_activation', sep = ''), c(2.8, 2))
generate_figs(umap_sig_anergy, paste('./plots/', experiment, '_prepare_umap_sig_anergy', sep = ''), c(2.8, 2))
generate_figs(umap_sig_stemness, paste('./plots/', experiment, '_prepare_umap_sig_stemness', sep = ''), c(2.8, 2))
generate_figs(umap_sig_senescence, paste('./plots/', experiment, '_prepare_umap_sig_senescence', sep = ''), c(2.8, 2))
generate_figs(umap_NKlike_Tex, paste('./plots/', experiment, '_prepare_umap_NKlike_Tex', sep = ''), c(2.8, 2))
generate_figs(umap_LCMV_Tex, paste('./plots/', experiment, '_prepare_umap_LCMV_Tex', sep = ''), c(2.8, 2))
...
scatterplot_CARTEx_630_NKlike_Tex <- FeatureScatter(expt.obj, 'CARTEx_630', 'NKlike_Tex', group.by = 'exposure', shuffle = TRUE, seed = 123, cols = c('skyblue', 'cadetblue'))
...
dmap_CARTEx_84 <- FeaturePlot(expt.obj, reduction = 'dm', features = c("CARTEx_84"), order = TRUE, pt.size = 0.1) + fix.sc + theme(plot.title = element_blank(), axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) + xlim(c(-0.06, 0.06)) + ylim(c(-0.06, 0.06))
dmap_CARTEx_200 <- FeaturePlot(expt.obj, reduction = 'dm', features = c("CARTEx_200"), order = TRUE, pt.size = 0.1) + fix.sc + theme(plot.title = element_blank(), axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) + xlim(c(-0.06, 0.06)) + ylim(c(-0.06, 0.06))
dmap_CARTEx_630 <- FeaturePlot(expt.obj, reduction = 'dm', features = c("CARTEx_630"), order = TRUE) + fix.sc + theme(plot.title = element_blank(), axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) + xlim(c(-0.06, 0.06)) + ylim(c(-0.06, 0.06))
dmap_sig_activation <- FeaturePlot(expt.obj, reduction = 'dm', features = c("Activation"), order = TRUE, pt.size = 0.1) + fix.sc + theme(plot.title = element_blank(), axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) + xlim(c(-0.06, 0.06)) + ylim(c(-0.06, 0.06))
dmap_sig_anergy <- FeaturePlot(expt.obj, reduction = 'dm', features = c("Anergy"), order = TRUE, pt.size = 0.1) + fix.sc + theme(plot.title = element_blank(), axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) + xlim(c(-0.06, 0.06)) + ylim(c(-0.06, 0.06))
...
generate_figs(dmap_CARTEx_630, paste('./plots/', experiment, '_prepare_dmap_CARTEx_630', sep = ''), c(2.8, 2))
generate_figs(dmap_sig_activation, paste('./plots/', experiment, '_prepare_dmap_sig_activation', sep = ''), c(2.8, 2))
