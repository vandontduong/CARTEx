...
aggplot_activation <- md %>% ggplot(aes(identifier2, Activation)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('day20','OldTerminal')), label = "p.signif", label.y = 2) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('day0','YoungNaive')), label = "p.signif", label.y = 2.5) +
  ylab("Activation") + xlab(NULL) + geom_point() + ylim(-1.5,3) + theme_classic() + theme(legend.position="none", text=element_text(size=16, color = "black")) +
  scale_x_discrete(labels = c("D0", "D20", "YN", "OT"))
...
aggplot_anergy <- md %>% ggplot(aes(identifier2, Anergy)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('day20','OldTerminal')), label = "p.signif", label.y = 2) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('day0','YoungNaive')), label = "p.signif", label.y = 2.5) +
  ylab("Anergy") + xlab(NULL) + geom_point() + ylim(-1.5,3) + theme_classic() + theme(legend.position="none", text=element_text(size=16, color = "black")) +
  scale_x_discrete(labels = c("D0", "D20", "YN", "OT"))
...
aggplot_senescence <- md %>% ggplot(aes(identifier2, Senescence)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('day20','OldTerminal')), label = "p.signif", label.y = 2) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('day0','YoungNaive')), label = "p.signif", label.y = 2.5) +
  ylab("Senescence") + xlab(NULL) + geom_point() + ylim(-1.5,3) + theme_classic() + theme(legend.position="none", text=element_text(size=16, color = "black")) +
  scale_x_discrete(labels = c("D0", "D20", "YN", "OT"))
...
aggplot_stemness <- md %>% ggplot(aes(identifier2, Stemness)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('day20','OldTerminal')), label = "p.signif", label.y = 2) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('day0','YoungNaive')), label = "p.signif", label.y = 2.5) +
  ylab("Stemness") + xlab(NULL) + geom_point() + ylim(-1.5,3) + theme_classic() + theme(legend.position="none", text=element_text(size=16, color = "black")) +
  scale_x_discrete(labels = c("D0", "D20", "YN", "OT"))
