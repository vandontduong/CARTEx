...
generate_figs(umap_phase, paste('./plots/', experiment, '_l_prepare_umap_phase', sep = ''), c(6,5))
...
generate_figs(barplot_monaco_age_group, paste('./plots/', experiment, '_l_prepare_barplot_monaco_age_group', sep = ''), c(8,4))
