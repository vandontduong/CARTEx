...
generate_figs(umap_seurat_clusters, paste('./plots/', experiment, '_cs_prepare_umap_seurat_clusters', sep = ''))
...
generate_figs(umap_age_group, paste('./plots/', experiment, '_cs_prepare_umap_age_group', sep = ''))

umap_age_group_2 <- DimPlot(expt.obj, reduction = "umap", group.by = "AgeGroup2", shuffle = TRUE, seed = 123)
generate_figs(umap_age_group_2, paste('./plots/', experiment, '_cs_prepare_umap_age_group_2', sep = ''))
...
generate_figs(umap_sex, paste('./plots/', experiment, '_cs_prepare_umap_sex', sep = ''))
...
generate_figs(umap_visit, paste('./plots/', experiment, '_cs_prepare_umap_visit', sep = ''))

umap_code <- DimPlot(expt.obj, reduction = "umap", group.by = "Code", shuffle = TRUE, seed = 123)
generate_figs(umap_code, paste('./plots/', experiment, '_cs_prepare_umap_code', sep = ''))

umap_cohort <- DimPlot(expt.obj, reduction = "umap", group.by = "Cohort", shuffle = TRUE, seed = 123)
generate_figs(umap_cohort, paste('./plots/', experiment, '_cs_prepare_umap_cohort', sep = ''))
