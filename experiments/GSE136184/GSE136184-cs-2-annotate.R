...
generate_figs(barplot_monaco_age_group_slim, paste('./plots/', experiment, '_cs_prepare_barplot_monaco_age_group_slim', sep = ''), c(2,2))

barplot_phase_age_group_slim <- barplot_phase_age_group + theme(legend.position = "none")
generate_figs(barplot_phase_age_group_slim, paste('./plots/', experiment, '_cs_prepare_barplot_phase_age_group_slim', sep = ''), c(2,2))
...
umap_CARTEx_84 <- FeaturePlot(expt.obj, features = c("CARTEx_84"), order = TRUE) + fix.sc + theme(plot.title = element_blank())
umap_CARTEx_200 <- FeaturePlot(expt.obj, features = c("CARTEx_200"), order = TRUE) + fix.sc + theme(plot.title = element_blank())
umap_CARTEx_630 <- FeaturePlot(expt.obj, features = c("CARTEx_630"), order = TRUE) + fix.sc + theme(plot.title = element_blank())
umap_sig_activation <- FeaturePlot(expt.obj, features = c("Activation"), order = TRUE) + fix.sc + theme(plot.title = element_blank())
umap_sig_anergy <- FeaturePlot(expt.obj, features = c("Anergy"), order = TRUE) + fix.sc + theme(plot.title = element_blank())
umap_sig_stemness <- FeaturePlot(expt.obj, features = c("Stemness"), order = TRUE) + fix.sc + theme(plot.title = element_blank())
umap_sig_senescence <- FeaturePlot(expt.obj, features = c("Senescence"), order = TRUE) + fix.sc + theme(plot.title = element_blank())
umap_NKlike_Tex <- FeaturePlot(expt.obj, features = c("NKlike_Tex"), order = TRUE) + fix.sc + theme(plot.title = element_blank())
umap_LCMV_Tex <- FeaturePlot(expt.obj, features = c("LCMV_Tex"), order = TRUE) + fix.sc + theme(plot.title = element_blank())
umap_BBD_Tex <- FeaturePlot(expt.obj, features = c("BBD_Tex"), order = TRUE) + fix.sc + theme(plot.title = element_blank())
umap_PD1_Tex <- FeaturePlot(expt.obj, features = c("PD1_Tex"), order = TRUE) + fix.sc + theme(plot.title = element_blank())
