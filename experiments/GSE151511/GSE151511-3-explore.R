...
generate_figs(barplot_monaco_response_slim_noNA, paste('./plots/', experiment, '_prepare_barplot_monaco_responder_slim_noNA', sep = ''), c(1,1.75))
...
generate_figs(barplot_phase_response_slim_noNA, paste('./plots/', experiment, '_prepare_barplot_phase_responder_slim_noNA', sep = ''), c(1,1.75))
...
umap_CARTEx_200_response <- FeaturePlotSplitBy(expt.obj, features = c("CARTEx_200"), split_identity = 'Responder', split_ids = c("NR", "R"), color_scale = fix.sc)
generate_figs(umap_CARTEx_200_response, paste('./plots/', experiment, '_prepare_umap_CARTEx_200_response', sep = ''), c(4,2))

umap_activation_response <- FeaturePlotSplitBy(expt.obj, features = c("Activation"), split_identity = 'Responder', split_ids = c("NR", "R"), color_scale = fix.sc)
generate_figs(umap_activation_response, paste('./plots/', experiment, '_prepare_umap_activation_response', sep = ''), c(4,2))

umap_anergy_response <- FeaturePlotSplitBy(expt.obj, features = c("Anergy"), split_identity = 'Responder', split_ids = c("NR", "R"), color_scale = fix.sc)
generate_figs(umap_anergy_response, paste('./plots/', experiment, '_prepare_umap_anergy_response', sep = ''), c(4,2))

umap_senescence_response <- FeaturePlotSplitBy(expt.obj, features = c("Senescence"), split_identity = 'Responder', split_ids = c("NR", "R"), color_scale = fix.sc)
generate_figs(umap_senescence_response, paste('./plots/', experiment, '_prepare_umap_senescence_response', sep = ''), c(4,2))

umap_stemness_response <- FeaturePlotSplitBy(expt.obj, features = c("Stemness"), split_identity = 'Responder', split_ids = c("NR", "R"), color_scale = fix.sc)
generate_figs(umap_stemness_response, paste('./plots/', experiment, '_prepare_umap_stemness_response', sep = ''), c(4,2))
