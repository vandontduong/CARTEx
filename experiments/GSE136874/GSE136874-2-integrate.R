...
split.ident.order = c("CD19", "GD2", "Newborn", "Young Naive", "Old Terminal")
Idents(query.obj) <- factor(Idents(query.obj), levels = split.ident.order)

query.obj$identifier2 <- factor(query.obj$identifier2, levels = c("CD19", "GD2", "Newborn", "Young Naive", "Old Terminal"))
