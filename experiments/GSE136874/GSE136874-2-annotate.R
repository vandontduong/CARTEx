...
generate_figs(barplot_monaco_CAR_slim, paste('./plots/', experiment, '_prepare_barplot_monaco_CAR_slim', sep = ''), c(1.25,1.75))
...
dmap_CARTEx_84 <- FeaturePlot(expt.obj, reduction = 'dm', features = c("CARTEx_84"), order = FALSE, pt.size = 0.1) + fix.sc + theme(plot.title = element_blank()) + xlim(c(-0.2, 0.2)) + ylim(c(-0.15, 0.2))
dmap_CARTEx_200 <- FeaturePlot(expt.obj, reduction = 'dm', features = c("CARTEx_200"), order = FALSE, pt.size = 0.1) + fix.sc + theme(plot.title = element_blank()) + xlim(c(-0.2, 0.2)) + ylim(c(-0.15, 0.2))
dmap_CARTEx_630 <- FeaturePlot(expt.obj, reduction = 'dm', features = c("CARTEx_630"), order = FALSE, pt.size = 0.1) + fix.sc + theme(plot.title = element_blank()) + xlim(c(-0.2, 0.2)) + ylim(c(-0.15, 0.2))
dmap_sig_activation <- FeaturePlot(expt.obj, reduction = 'dm', features = c("Activation"), order = FALSE, pt.size = 0.1) + fix.sc + theme(plot.title = element_blank()) + xlim(c(-0.2, 0.2)) + ylim(c(-0.15, 0.2))
dmap_sig_anergy <- FeaturePlot(expt.obj, reduction = 'dm', features = c("Anergy"), order = FALSE, pt.size = 0.1) + fix.sc + theme(plot.title = element_blank()) + xlim(c(-0.2, 0.2)) + ylim(c(-0.15, 0.2))
dmap_sig_stemness <- FeaturePlot(expt.obj, reduction = 'dm', features = c("Stemness"), order = FALSE, pt.size = 0.1) + fix.sc + theme(plot.title = element_blank()) + xlim(c(-0.2, 0.2)) + ylim(c(-0.15, 0.2))
dmap_sig_senescence <- FeaturePlot(expt.obj, reduction = 'dm', features = c("Senescence"), order = FALSE, pt.size = 0.1) + fix.sc + theme(plot.title = element_blank()) + xlim(c(-0.2, 0.2)) + ylim(c(-0.15, 0.2))
dmap_TSR <- FeaturePlot(expt.obj, reduction = 'dm', features = c("TSR"), order = FALSE, pt.size = 0.1) + fix.sc + theme(plot.title = element_blank()) + xlim(c(-0.2, 0.2)) + ylim(c(-0.15, 0.2))
dmap_Tex_Term <- FeaturePlot(expt.obj, reduction = 'dm', features = c("Tex_Term"), order = FALSE, pt.size = 0.1) + fix.sc + theme(plot.title = element_blank()) + xlim(c(-0.2, 0.2)) + ylim(c(-0.15, 0.2))
dmap_Tex_KLR <- FeaturePlot(expt.obj, reduction = 'dm', features = c("Tex_KLR"), order = FALSE, pt.size = 0.1) + fix.sc + theme(plot.title = element_blank()) + xlim(c(-0.2, 0.2)) + ylim(c(-0.15, 0.2))
...
generate_figs(histplot_CARTEx_200, paste('./plots/', experiment, '_prepare_histplot_CARTEx_200', sep = ''), c(1.75,1.5))
...
generate_figs(histplot_CARTEx_200_split_monaco, paste('./plots/', experiment, '_prepare_histplot_CARTEx_200_split_monaco', sep = ''), c(2.6,1.5))

histplot_CARTEx_200_split_CAR <- ggplot(as.data.frame(expt.obj@meta.data), aes(x = CARTEx_200, fill = CAR)) +
  geom_histogram(binwidth = 0.5, color = "white") + ggtitle(NULL) + xlab("CARTEx") + xlim(-4,4) + 
  scale_fill_manual(values = c("dodgerblue", "indianred")) + 
  theme_classic() + theme(text = element_text(color = "black"), axis.text = element_text(color = "black"), axis.title = element_text(color = "black"))

generate_figs(histplot_CARTEx_200_split_CAR, paste('./plots/', experiment, '_prepare_histplot_CARTEx_200_split_CAR', sep = ''), c(2.4,1.5))
