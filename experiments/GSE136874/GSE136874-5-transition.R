...
generate_figs(transitplot_CAR_CARTEx_84, paste('./plots/', experiment, '_transition_transitplot_CAR_CARTEx_84', sep = ''), c(7, 3))

transitplot_CAR_CARTEx_200 <- ggplot(md, aes(x = DC1rank, y = CAR, colour = CARTEx_200)) +
  geom_quasirandom(groupOnX = FALSE) + fix.sc + theme_bw()
generate_figs(transitplot_CAR_CARTEx_200, paste('./plots/', experiment, '_transition_transitplot_CAR_CARTEx_200', sep = ''), c(7, 3))

transitplot_CAR_CARTEx_630 <- ggplot(md, aes(x = DC1rank, y = CAR, colour = CARTEx_630)) +
  geom_quasirandom(groupOnX = FALSE) + fix.sc + theme_bw()
generate_figs(transitplot_CAR_CARTEx_630, paste('./plots/', experiment, '_transition_transitplot_CAR_CARTEx_630', sep = ''), c(7, 4))

transitplot_CAR_activation <- ggplot(md, aes(x = DC1rank, y = CAR, colour = Activation)) +
  geom_quasirandom(groupOnX = FALSE) + fix.sc + theme_bw()
generate_figs(transitplot_CAR_activation, paste('./plots/', experiment, '_transition_transitplot_CAR_activation', sep = ''), c(7, 4))

transitplot_CAR_anergy <- ggplot(md, aes(x = DC1rank, y = CAR, colour = Anergy)) +
  geom_quasirandom(groupOnX = FALSE) + fix.sc + theme_bw()
generate_figs(transitplot_CAR_anergy, paste('./plots/', experiment, '_transition_transitplot_CAR_anergy', sep = ''), c(7, 4))

transitplot_CAR_senescence <- ggplot(md, aes(x = DC1rank, y = CAR, colour = Senescence)) +
  geom_quasirandom(groupOnX = FALSE) + fix.sc + theme_bw()
generate_figs(transitplot_CAR_senescence, paste('./plots/', experiment, '_transition_transitplot_CAR_senescence', sep = ''), c(7, 4))

transitplot_CAR_stemness <- ggplot(md, aes(x = DC1rank, y = CAR, colour = Stemness)) +
  geom_quasirandom(groupOnX = FALSE) + fix.sc + theme_bw()
generate_figs(transitplot_CAR_stemness, paste('./plots/', experiment, '_transition_transitplot_CAR_stemness', sep = ''), c(7, 4))

transitplot_CAR_LCMV_Tex <- ggplot(md, aes(x = DC1rank, y = CAR, colour = LCMV_Tex)) +
  geom_quasirandom(groupOnX = FALSE) + fix.sc + theme_bw()
generate_figs(transitplot_CAR_LCMV_Tex, paste('./plots/', experiment, '_transition_transitplot_CAR_LCMV_Tex', sep = ''), c(7, 4))

transitplot_CAR_NKlike_Tex <- ggplot(md, aes(x = DC1rank, y = CAR, colour = NKlike_Tex)) +
  geom_quasirandom(groupOnX = FALSE) + fix.sc + theme_bw()
generate_figs(transitplot_CAR_NKlike_Tex, paste('./plots/', experiment, '_transition_transitplot_CAR_NKlike_Tex', sep = ''), c(7, 4))

transitplot_CAR_BBD_Tex <- ggplot(md, aes(x = DC1rank, y = CAR, colour = BBD_Tex)) +
  geom_quasirandom(groupOnX = FALSE) + fix.sc + theme_bw()
generate_figs(transitplot_CAR_BBD_Tex, paste('./plots/', experiment, '_transition_transitplot_CAR_BBD_Tex', sep = ''), c(7, 4))

transitplot_CAR_PD1_Tex <- ggplot(md, aes(x = DC1rank, y = CAR, colour = PD1_Tex)) +
  geom_quasirandom(groupOnX = FALSE) + fix.sc + theme_bw()
generate_figs(transitplot_CAR_PD1_Tex, paste('./plots/', experiment, '_transition_transitplot_CAR_PD1_Tex', sep = ''), c(7, 4))
...
generate_figs(plot_volcano_DC1rank_g1200_aGD2, paste('./plots/', experiment, '_transition_volcano_DC1rank_g1200_aGD2', sep = ''), c(12, 8))
