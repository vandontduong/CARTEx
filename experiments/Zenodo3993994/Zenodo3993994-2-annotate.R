...
### Script name: Zenodo3993994-2-annotate.R
...
generate_figs(barplot_azimuth_disease, paste('./plots/', experiment, '_prepare_barplot_azimuth_disease', sep = ''), c(8,4))

barplot_monaco_disease <- BarPlotStackSplit(expt.obj, 'monaco', 'Disease', color_set = c('deepskyblue', 'seagreen', 'darkgoldenrod', 'plum3'))
generate_figs(barplot_monaco_disease, paste('./plots/', experiment, '_prepare_barplot_monaco_disease', sep = ''), c(6,4))

barplot_dice_disease <- BarPlotStackSplit(expt.obj, 'dice', 'Disease')
generate_figs(barplot_dice_disease, paste('./plots/', experiment, '_prepare_barplot_dice_disease', sep = ''), c(8,4))

barplot_phase_disease <- BarPlotStackSplit(expt.obj, 'Phase', 'Disease', color_set = hcl.colors(3, palette = "Temps"))
generate_figs(barplot_phase_disease, paste('./plots/', experiment, '_prepare_barplot_phase_disease', sep = ''), c(5,4))
...
generate_figs(umap_TSR, paste('./plots/', experiment, '_prepare_umap_TSR', sep = ''), c(5.5,5))
