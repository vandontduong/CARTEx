...
### Script name: Zenodo3993994-blood-5-integrate.R
### Description: explore seurat object for Zenodo3993994
### Author: Vandon Duong
...
expt.obj@meta.data[['identifier2']] <- expt.obj@meta.data$sampleType
...
saveRDS(query.obj, file = paste('./data/', experiment, '_blood_query_scored.rds', sep = ''))

# query.obj <- readRDS(paste('./data/', experiment, '_blood_query_scored.rds', sep = ''))
