...
### Script name: Zenodo3993994-3-explore.R
...
generate_figs(vlnplot_sample_type_exhaustion_markers, paste('./plots/', experiment, '_explore_vlnplot_sample_type_exhaustion_markers', sep = ''), c(8,6))
...
generate_figs(featplot_CARTEx_combined_sample_type, paste('./plots/', experiment, '_featplot_CARTEx_combined_sample_type', sep = ''), c(10,5))
...
generate_figs(vlnplot_CARTEx_disease_monaco_split, paste('./plots/', experiment, '_prepare_vlnplot_CARTEx_disease_monaco_split', sep = ''), c(12,5)) 
...
generate_figs(vlnplot_CARTEx_disease_monaco, paste('./plots/', experiment, '_prepare_vlnplot_CARTEx_disease_monaco', sep = ''), c(12,5)) 
...
generate_figs(swarmplot_CARTEx_disease_monaco, paste('./plots/', experiment, '_prepare_swarmplot_CARTEx_disease_monaco', sep = ''), c(6,5)) 
...
generate_figs(aggplot_CARTEx_200_disease_monaco_split, paste('./plots/', experiment, '_aggplot_CARTEx_200_disease_monaco_split', sep = ''), c(6,5)) 
...
generate_figs(plot_volcano_AD_MCI_CSF, paste('./plots/', experiment, '_explore_plot_volcano_AD_MCI_CSF', sep = ''), c(10, 8))
...
generate_figs(umap_clonotype_count, paste('./plots/', experiment, '_prepare_umap_clonotype_count', sep = ''), c(5.5,5))
generate_figs(umap_clonotype_count_log2, paste('./plots/', experiment, '_prepare_umap_clonotype_count_log2', sep = ''), c(5.5,5))
