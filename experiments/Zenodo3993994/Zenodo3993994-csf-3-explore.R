...
expt.obj@meta.data$Disease <- plyr::mapvalues(x = expt.obj@meta.data$Disease,
                                              ...
                                              to = c('P', 'C_B', 'A', 'M', 'C'))
expt.obj@meta.data$Disease <- factor(expt.obj@meta.data$Disease, levels = c('A', 'M', 'C'))
...
generate_figs(umap_CARTEx_200_monaco, paste('./plots/', experiment, '_csf_prepare_umap_CARTEx_200_monaco', sep = ''), c(8,2))
...
generate_figs(umap_activation_monaco, paste('./plots/', experiment, '_csf_prepare_umap_activation_monaco', sep = ''), c(8,2))
...
generate_figs(umap_anergy_monaco, paste('./plots/', experiment, '_csf_prepare_umap_anergy_monaco', sep = ''), c(8,2))
...
generate_figs(umap_CARTEx_200_phase, paste('./plots/', experiment, '_csf_prepare_umap_CARTEx_200_phase', sep = ''), c(6,2))

umap_CARTEx_200_disease <- FeaturePlotSplitBy(expt.obj, features = c("CARTEx_200"), split_identity = 'Disease', split_ids = c('A', 'M', 'C'), color_scale = fix.sc)
generate_figs(umap_CARTEx_200_disease, paste('./plots/', experiment, '_csf_prepare_umap_CARTEx_200_disease', sep = ''), c(4,2))
