...
### Script name: Zenodo3993994-1-prepare.R
...
generate_figs(umap_sample_source, paste('./plots/', experiment, '_prepare_umap_sample_source', sep = ''), c(6, 5))
...
generate_figs(umap_sample_type, paste('./plots/', experiment, '_prepare_umap_sample_type', sep = ''), c(6.5, 5))
...
generate_figs(dmap_disease, paste('./plots/', experiment, '_prepare_dmap_disease', sep = ''), c(6.5, 5))
...
generate_figs(barplot_sample_source_seurat_clusters, paste('./plots/', experiment, '_prepare_barplot_sample_source_seurat_clusters', sep = ''), c(8,4))
