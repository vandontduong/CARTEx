...
CART.combined.CD8pos <- SetIdent(CART.combined.CD8pos, value = "Affstat")
...
umap_group <- DimPlot(CART.combined.CD8pos, reduction = "umap", group.by = "Affstat", shuffle = TRUE, seed = 123)
generate_figs(umap_group, paste('./plots/', experiment, '_umap_group', sep = ''))

umap_stim <- DimPlot(CART.combined.CD8pos, reduction = "umap", group.by = "Stim", shuffle = TRUE, seed = 123)
generate_figs(umap_stim, paste('./plots/', experiment, '_umap_stim', sep = ''))

umap_sample <- DimPlot(CART.combined.CD8pos, reduction = "umap", group.by = "Sample", shuffle = TRUE, seed = 123)
generate_figs(umap_sample, paste('./plots/', experiment, '_umap_sample', sep = ''))
