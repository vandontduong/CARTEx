...
custom_labels <- c('Control\nRested', 'Control\nStimulated', 'STAT3_GOF\nRested', 'STAT3_GOF\nStimulated', 'YoungNaive', 'OldTerminal')

aggplot_CARTEx_84 <- md %>% ggplot(aes(identifier4, CARTEx_84)) +
  geom_bar(stat = "summary", fun = "mean", aes(fill = identifier4)) +
  scale_fill_manual(values = c("lightsteelblue", "steelblue", "palevioletred", "violetred", "royalblue", "orchid")) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('Control-Rested','STAT3-GOF-Stimulated')), label = "p.signif", label.y = 2.4) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('Control-Rested','YoungNaive')), label = "p.signif", label.y = 2.8) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Stimulated','OldTerminal')), label = "p.signif", label.y = 2) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Stimulated','STAT3-GOF-Rested')), label = "p.signif", label.y = 1.6) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Rested','Control-Stimulated')), label = "p.signif", label.y = 2) +
  ylab("CARTEx 84") + xlab(NULL) + geom_point() + ylim(-3, 3) + theme(legend.position="none") + scale_x_discrete(labels = custom_labels)
...
aggplot_CARTEx_200 <- md %>% ggplot(aes(identifier4, CARTEx_200)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Stimulated','STAT3-GOF-Rested')), label = "p.signif", label.y = 1.6) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Rested','Control-Stimulated')), label = "p.signif", label.y = 2) +
  ylab("CARTEx 200") + xlab(NULL) + geom_point() + ylim(-3, 3) + theme(legend.position="none") + scale_x_discrete(labels = custom_labels)
...
aggplot_CARTEx_630 <- md %>% ggplot(aes(identifier4, CARTEx_630)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Stimulated','STAT3-GOF-Rested')), label = "p.signif", label.y = 1.6) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Rested','Control-Stimulated')), label = "p.signif", label.y = 2) +
  ylab("CARTEx 630") + xlab(NULL) + geom_point() + ylim(-3, 3) + theme(legend.position="none") + scale_x_discrete(labels = custom_labels)
...
aggplot_NKlike_Tex <- md %>% ggplot(aes(identifier4, NKlike_Tex)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Stimulated','STAT3-GOF-Rested')), label = "p.signif", label.y = 1.6) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Rested','Control-Stimulated')), label = "p.signif", label.y = 2) +
  ylab("NK-like") + xlab(NULL) + geom_point() + ylim(-3, 3) + theme(legend.position="none") + scale_x_discrete(labels = custom_labels)
...
aggplot_LCMV_Tex <- md %>% ggplot(aes(identifier4, LCMV_Tex)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Stimulated','STAT3-GOF-Rested')), label = "p.signif", label.y = 1.6) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Rested','Control-Stimulated')), label = "p.signif", label.y = 2) +
  ylab("LCMV") + xlab(NULL) + geom_point() + ylim(-3, 3) + theme(legend.position="none") + scale_x_discrete(labels = custom_labels)
...
aggplot_BBD_Tex <- md %>% ggplot(aes(identifier4, BBD_Tex)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Stimulated','STAT3-GOF-Rested')), label = "p.signif", label.y = 1.6) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Rested','Control-Stimulated')), label = "p.signif", label.y = 2) +
  ylab("BBD") + xlab(NULL) + geom_point() + ylim(-3, 3) + theme(legend.position="none") + scale_x_discrete(labels = custom_labels)
...
aggplot_PD1_Tex <- md %>% ggplot(aes(identifier4, PD1_Tex)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Stimulated','STAT3-GOF-Rested')), label = "p.signif", label.y = 1.6) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Rested','Control-Stimulated')), label = "p.signif", label.y = 2) +
  ylab("PD1") + xlab(NULL) + geom_point() + ylim(-3, 3) + theme(legend.position="none") + scale_x_discrete(labels = custom_labels)
...
custom_labels <- c('Control (R)', 'Control (S)', 'STAT3_GOF (R)', 'STAT3_GOF (S)', 'YoungNaive', 'OldTerminal')
...
aggplot_CARTEx_84 <- md %>% ggplot(aes(identifier4, CARTEx_84)) +
  ...
  ylab("CARTEx 84") + xlab(NULL) + geom_point() + ylim(-3, 3) + theme_classic() + theme(legend.position="none", text=element_text(size=16)) + scale_x_discrete(labels = custom_labels)
generate_figs(aggplot_CARTEx_84, paste('./plots/', experiment, '_query_agg_aggplot_CARTEx_84', sep = ''), c(5.5,5))
...
aggplot_CARTEx_200 <- md %>% ggplot(aes(identifier4, CARTEx_200)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('Control-Rested','YoungNaive')), label = "p.signif", label.y = 2.5) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Stimulated','OldTerminal')), label = "p.signif", label.y = 1.7) +
  ylab("CARTEx 200") + xlab(NULL) + geom_point() + ylim(-3, 3) + theme_classic() + theme(legend.position="none", text=element_text(size=16)) + scale_x_discrete(labels = custom_labels)
generate_figs(aggplot_CARTEx_200, paste('./plots/', experiment, '_query_agg_aggplot_CARTEx_200', sep = ''), c(5.5,5))
...
aggplot_CARTEx_630 <- md %>% ggplot(aes(identifier4, CARTEx_630)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('Control-Rested','YoungNaive')), label = "p.signif", label.y = 2.5) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Stimulated','OldTerminal')), label = "p.signif", label.y = 1.7) +
  ylab("CARTEx 630") + xlab(NULL) + geom_point() + ylim(-3, 3) + theme_classic() + theme(legend.position="none", text=element_text(size=16)) + scale_x_discrete(labels = custom_labels)
generate_figs(aggplot_CARTEx_630, paste('./plots/', experiment, '_query_agg_aggplot_CARTEx_630', sep = ''), c(5.5,5))
...
aggplot_activation <- md %>% ggplot(aes(identifier4, Activation)) +
  geom_bar(stat = "summary", fun = "mean", aes(fill = identifier4)) +
  scale_fill_manual(values=c("lightsteelblue", "steelblue", "palevioletred", "violetred", "royalblue", "orchid")) +
  xlab("CAR T cells and controls") + geom_point() + theme_classic() + theme(legend.position="none", text=element_text(size=16)) + scale_x_discrete(labels = custom_labels)
...
aggplot_NKlike_Tex <- md %>% ggplot(aes(identifier4, NKlike_Tex)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('Control-Rested','YoungNaive')), label = "p.signif", label.y = 2.5) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Stimulated','OldTerminal')), label = "p.signif", label.y = 1.7) +
  ylab("NK-like") + xlab(NULL) + geom_point() + ylim(-3, 3) + theme_classic() + theme(legend.position="none", text=element_text(size=16)) + scale_x_discrete(labels = custom_labels)
generate_figs(aggplot_NKlike_Tex, paste('./plots/', experiment, '_query_agg_aggplot_NKlike_Tex', sep = ''), c(5.5,5))
...
aggplot_LCMV_Tex <- md %>% ggplot(aes(identifier4, LCMV_Tex)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('Control-Rested','YoungNaive')), label = "p.signif", label.y = 2.5) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Stimulated','OldTerminal')), label = "p.signif", label.y = 1.7) +
  ylab("LCMV") + xlab(NULL) + geom_point() + ylim(-3, 3) + theme_classic() + theme(legend.position="none", text=element_text(size=16)) + scale_x_discrete(labels = custom_labels)
generate_figs(aggplot_LCMV_Tex, paste('./plots/', experiment, '_query_agg_aggplot_LCMV_Tex', sep = ''), c(5.5,5))
...
aggplot_BBD_Tex <- md %>% ggplot(aes(identifier4, BBD_Tex)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('Control-Rested','YoungNaive')), label = "p.signif", label.y = 2.5) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Stimulated','OldTerminal')), label = "p.signif", label.y = 1.7) +
  ylab("BBD") + xlab(NULL) + geom_point() + ylim(-3, 3) + theme_classic() + theme(legend.position="none", text=element_text(size=16)) + scale_x_discrete(labels = custom_labels)
generate_figs(aggplot_BBD_Tex, paste('./plots/', experiment, '_query_agg_aggplot_BBD_Tex', sep = ''), c(5.5,5))
...
aggplot_PD1_Tex <- md %>% ggplot(aes(identifier4, PD1_Tex)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('Control-Rested','YoungNaive')), label = "p.signif", label.y = 2.5) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Stimulated','OldTerminal')), label = "p.signif", label.y = 1.7) +
  ylab("PD1") + xlab(NULL) + geom_point() + ylim(-3, 3) + theme_classic() + theme(legend.position="none", text=element_text(size=16)) + scale_x_discrete(labels = custom_labels)
generate_figs(aggplot_PD1_Tex, paste('./plots/', experiment, '_query_agg_aggplot_PD1_Tex', sep = ''), c(5.5,5))
