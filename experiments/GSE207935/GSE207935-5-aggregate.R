...
### Script name: GSE207935-4-aggregate.R
...
aggplot_activation <- md %>% ggplot(aes(identifier4, Activation)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('Control-Rested','YoungNaive')), label = "p.signif", label.y = 2.5) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Stimulated','OldTerminal')), label = "p.signif", label.y = 1.7) +
  ylab("Activation") + xlab(NULL) + geom_point() + ylim(-2, 3) + theme_classic() + theme(legend.position="none", text=element_text(size=16, color = "black")) + scale_x_discrete(labels = custom_labels)
generate_figs(aggplot_activation, paste('./plots/', experiment, '_query_agg_aggplot_activation', sep = ''), c(4,3))
...
aggplot_anergy <- md %>% ggplot(aes(identifier4, Anergy)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('Control-Rested','YoungNaive')), label = "p.signif", label.y = 2.5) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Stimulated','OldTerminal')), label = "p.signif", label.y = 1.7) +
  ylab("Anergy") + xlab(NULL) + geom_point() + ylim(-2, 3) + theme_classic() + theme(legend.position="none", text=element_text(size=16, color = "black")) + scale_x_discrete(labels = custom_labels)
generate_figs(aggplot_anergy, paste('./plots/', experiment, '_query_agg_aggplot_anergy', sep = ''), c(4,3))
...
aggplot_senescence <- md %>% ggplot(aes(identifier4, Senescence)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('Control-Rested','YoungNaive')), label = "p.signif", label.y = 2.5) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Stimulated','OldTerminal')), label = "p.signif", label.y = 1.7) +
  ylab("Senescence") + xlab(NULL) + geom_point() + ylim(-2, 3) + theme_classic() + theme(legend.position="none", text=element_text(size=16, color = "black")) + scale_x_discrete(labels = custom_labels)
generate_figs(aggplot_senescence, paste('./plots/', experiment, '_query_agg_aggplot_senescence', sep = ''), c(4,3))
...
aggplot_stemness <- md %>% ggplot(aes(identifier4, Stemness)) +
  ...
  stat_compare_means(method = "wilcox.test", comparisons = list(c('Control-Rested','YoungNaive')), label = "p.signif", label.y = 2.5) +
  stat_compare_means(method = "wilcox.test", comparisons = list(c('STAT3-GOF-Stimulated','OldTerminal')), label = "p.signif", label.y = 1.7) +
  ylab("Stemness") + xlab(NULL) + geom_point() + ylim(-2, 3) + theme_classic() + theme(legend.position="none", text=element_text(size=16, color = "black")) + scale_x_discrete(labels = custom_labels)
generate_figs(aggplot_stemness, paste('./plots/', experiment, '_query_agg_aggplot_stemness', sep = ''), c(4,3))
