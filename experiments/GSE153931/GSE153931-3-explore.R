...
featplot_CARTEx_630_severity_x <- FeatureScatter(expt.obj.subset, feature1 = 'PFSD.CARTEx_630', feature2 = 'CARTEx_630', group.by = 'orig.severity_x', cols=c('cadetblue', 'violetred', 'indianred'), shuffle = TRUE, seed = 123) + theme(legend.position = 'none') + ylab('CARTEx 630') + xlab('% detected of CARTEx 630') + xlim(c(0, 30)) + ylim(c(-3, 5))
featplot_CARTEx_200_severity_x <- FeatureScatter(expt.obj.subset, feature1 = 'PFSD.CARTEx_200', feature2 = 'CARTEx_200', group.by = 'orig.severity_x', cols=c('cadetblue', 'violetred', 'indianred'), shuffle = TRUE, seed = 123) + theme(legend.position = 'none') + ylab('CARTEx 200') + xlab('% detected of CARTEx 200') + xlim(c(0, 30)) + ylim(c(-3, 5))
featplot_CARTEx_84_severity_x <- FeatureScatter(expt.obj.subset, feature1 = 'PFSD.CARTEx_84', feature2 = 'CARTEx_84', group.by = 'orig.severity_x', cols=c('cadetblue', 'violetred', 'indianred'), shuffle = TRUE, seed = 123) + theme(legend.position = 'none') + ylab('CARTEx 84') + xlab('% detected of CARTEx 84') + xlim(c(0, 30)) + ylim(c(-3, 5))
