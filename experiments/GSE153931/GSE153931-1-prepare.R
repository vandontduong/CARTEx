...
CART.combined.CD8pos <- CreateSeuratObject(counts = countsData, min.cells = 3, min.features = 200)
CART.combined.CD8pos@meta.data$orig.ident <- annotatedData$orig.ident
CART.combined.CD8pos@meta.data$origlib <- annotatedData$origlib
CART.combined.CD8pos@meta.data$orig.project_id <- annotatedData$orig.project_id
CART.combined.CD8pos@meta.data$orig.n_donors <- annotatedData$orig.n_donors
CART.combined.CD8pos@meta.data$percent.mt <- annotatedData$percent.mt
CART.combined.CD8pos@meta.data$orig.project_group <- annotatedData$orig.project_group
CART.combined.CD8pos@meta.data$orig.virus <- annotatedData$orig.virus
CART.combined.CD8pos@meta.data$orig.virus2 <- annotatedData$orig.virus2
CART.combined.CD8pos@meta.data$orig.asthma <- annotatedData$orig.asthma
CART.combined.CD8pos@meta.data$orig.peptide <- annotatedData$orig.peptide
CART.combined.CD8pos@meta.data$orig.donor <- annotatedData$orig.donor
CART.combined.CD8pos@meta.data$orig.donors <- annotatedData$orig.donors
CART.combined.CD8pos@meta.data$orig.severity <- annotatedData$orig.severity
CART.combined.CD8pos@meta.data$orig.severity_score <- annotatedData$orig.severity_score
CART.combined.CD8pos@meta.data$orig.severity_x <- annotatedData$orig.severity_x
CART.combined.CD8pos@meta.data$drug <- annotatedData$drug
CART.combined.CD8pos@meta.data$orig.diabetes <- annotatedData$orig.diabetes
CART.combined.CD8pos@meta.data$age <- annotatedData$age
CART.combined.CD8pos@meta.data$orig.sex <- annotatedData$orig.sex
CART.combined.CD8pos@meta.data$cardiovascular <- annotatedData$cardiovascular
CART.combined.CD8pos@meta.data$tumour <- annotatedData$tumour
CART.combined.CD8pos@meta.data$orig.hospital <- annotatedData$orig.hospital
CART.combined.CD8pos@meta.data$orig.unit <- annotatedData$orig.unit


# eliminate void donors
CART.combined.CD8pos <- SetIdent(CART.combined.CD8pos, value = "orig.donor")
CART.combined.CD8pos <- subset(CART.combined.CD8pos,cells=colnames(CART.combined.CD8pos)[Idents(CART.combined.CD8pos) !="void"])
