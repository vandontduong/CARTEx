...
description = "TILs from cancer patients receiving immune checkpoint blockade"
...
pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_umap_response.png", left = Inches(0.5), top = Inches(1), height = Inches(3))
...
pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_barplot_phase_response.png", left = Inches(5.5), top = Inches(4.5), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_barplot_monaco_response.png", left = Inches(10.5), top = Inches(4.5), height = Inches(3))

# new slide
slide = add_slide(prs, blank_slide_layout, "Correspondence analysis of contingency tables of metadata")

pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_corr_timepoint_response_phase.png", left = Inches(0.5), top = Inches(1), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_corr_monaco_phase.png", left = Inches(5.5), top = Inches(1), height = Inches(3))
...
pic = slide.shapes.add_picture("./plots/" + experiment + "_featplot_CARTEx_combined_baseline_response.png", left = Inches(0.25), top = Inches(1), height = Inches(4))

# new slide
slide = add_slide(prs, blank_slide_layout, "Cell type differentiation")

pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_vlnplot_CARTEx_response_monaco_response.png", left = Inches(0.25), top = Inches(1), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_swarmplot_CARTEx_response_monaco_baseline_response.png", left = Inches(0.25), top = Inches(4.5), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_aggplot_CARTEx_200_response_monaco_split_baseline_response_countsized.png", left = Inches(8.25), top = Inches(1), height = Inches(5))


# new slide
slide = add_slide(prs, blank_slide_layout, "Violin plots for canonical exhaustion markers (baseline)")

pic = slide.shapes.add_picture("./plots/" + experiment + "_prepare_vlnplot_response_exhaustion_markers_baseline.png", left = Inches(0.5), top = Inches(1), height = Inches(8))
...
pic = slide.shapes.add_picture("./plots/" + experiment + "_query_agg_aggplot_CARTEx_630_baseline.png", left = Inches(0.25), top = Inches(1), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_query_agg_aggplot_CARTEx_200_baseline.png", left = Inches(4.25), top = Inches(1), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_query_agg_aggplot_CARTEx_84_baseline.png", left = Inches(8.25), top = Inches(1), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_query_agg_aggplot_LCMV_Tex_baseline.png", left = Inches(0.25), top = Inches(4.5), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_query_agg_aggplot_NKlike_Tex_baseline.png", left = Inches(4.25), top = Inches(4.5), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_query_agg_aggplot_BBD_Tex_baseline.png", left = Inches(8.25), top = Inches(4.5), height = Inches(3))

pic = slide.shapes.add_picture("./plots/" + experiment + "_query_agg_aggplot_PD1_Tex_baseline.png", left = Inches(12.25), top = Inches(4.5), height = Inches(3))


# new slide
slide = add_slide(prs, blank_slide_layout, "Differentially expressed genes")

pic = slide.shapes.add_picture("./plots/" + experiment + "_plot_volcano_baseline_response.png", left = Inches(0.5), top = Inches(1), height = Inches(5))
